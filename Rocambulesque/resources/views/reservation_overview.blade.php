        ...
        <main>
            ...
            <form class="container" method="get" action="get">
                ...
                <div class="info">
                    ...
                    <div class="input">
                        <!--here the datetime information will be getting from the database bij get method-->
                        <label for="">
                            Datum en Tijd :
                        </label>
                    ...
                    <div class="input">
                            <!--here the amount people information will be getting from the database bij get method-->
                        <label for="">
                            Aantal Personen :
                        </label>
